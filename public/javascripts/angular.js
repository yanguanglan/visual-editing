 ...
 */
	...
	function Browser(window, document, $log, $sniffer) {
		 ...
		 */
		self.cookies = function(name, value) { /* global escape: false, unescape: false */
	...
	var inputDirective = ['$browser', '$sniffer', '$filter', function($browser, $sniffer, $filter) {
		return {
			...
			link: function(scope, element, attr, ctrls) {
				if (ctrls[0]) {
					(inputType[lowercase(attr.type)] || inputType.text)(scope, element, attr, ctrls[0], $sniffer, $browser, $filter);
				}
			}
		};
	}];
